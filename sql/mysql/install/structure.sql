...
CREATE TABLE cms (
	...
	c_query VARCHAR(255) NOT NULL UNIQUE,
...
INSERT INTO user (u_user,u_password) VALUES('spooky',SHA1('spooky'));
INSERT INTO user (u_user,u_password) VALUES('booky',SHA1('spooky'));
INSERT INTO user (u_user,u_password) VALUES('looky',SHA1('spooky'));
INSERT INTO user (u_user,u_password) VALUES('tooky',SHA1('spooky'));
